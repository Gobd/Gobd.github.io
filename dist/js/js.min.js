...
$(document).ready(function(){function t(t){t?a.css("visibility","visible"):a.css("visibility","hidden")}function n(){$(window).scrollTop(stateObj.scrollData-70)}function i(){"#/asd"===window.location.hash?stateObj.testHtml?(o.html(stateObj.testHtml),t(!0),$(window).off()):$.get("/test.html",function(t){}).then(function(n){stateObj.testHtml=n,o.html(n),t(!0),$(window).off()}):(window.location.hash="#",stateObj.indexHtml?(o.html(stateObj.indexHtml),mainPage(),t(!0),n()):$.get("/mainTemp.html",function(t){}).then(function(i){stateObj.indexHtml=i,o.html(i),mainPage(),t(!0),n()}))}stateObj={};var o=$("#main"),a=$("body");window.onhashchange=function(){t(!1),i()},window.location.hash&&"#/"!==window.location.hash||o.html()&&(stateObj.indexHtml=o.html()),i()});
function mainPage(){function o(o){var t=1,n=function(){c.text(o.slice(0,t)),t++,t===e.length+1&&clearInterval(s)},i=function(){return 50*Math.random()+70},s=window.setInterval(n,i())}function t(o){var t=o.getBoundingClientRect().top,n=o.getBoundingClientRect().bottom,e=t>=0&&n<=window.innerHeight;return e}function n(){768>a?(l.css("background-color","white"),d.css("color","black")):75>s?(l.css("background-color","transparent"),d.css("color","#ebeaea")):(l.css("background-color","white"),d.css("color","black"))}var e="Full Stack Web Developer | UI/UX | JavaScript",c=$("#devInfo");o(e);var i=document.getElementsByTagName("svg"),s=$(window).scrollTop()+70,a=$(window).width(),r=$("#innerNav"),l=$("#navigation"),d=l.find("a"),u=$("#navToggle");$(document).on("click","#navToggle",function(){u.toggleClass("active"),"65px"===r.css("max-height")?r.css("max-height","500px"):r.css("max-height","65px")}),$(document).on("click",".navLink",function(){u.hasClass("active")&&u.removeClass("active"),r.css("max-height","65px")}),$(window).resize(function(){a=$(window).width(),n()}),n();var f=$("#navSkills"),v=$("#navPortfolio"),g=$("#navContact"),p=$("#top"),h=$("#portfolio"),x=$("#skills"),w=$("#about"),m=$("#navAbout");$(window).scroll(function(){s=$(window).scrollTop()+70,stateObj.scrollData=s,n(),[].forEach.call(i,function(o){t(o)?$(o).addClass("svgGrow"):$(o).removeClass("svgGrow")}),s<p.offset().top+p.height()&&(m.css("text-decoration","none"),f.css("text-decoration","none"),v.css("text-decoration","none"),g.css("text-decoration","none")),s>h.offset().top&&s<h.offset().top+h.height()&&(m.css("text-decoration","none"),f.css("text-decoration","none"),v.css("text-decoration","underline"),g.css("text-decoration","none")),s>x.offset().top&&s<x.offset().top+x.height()&&(m.css("text-decoration","none"),f.css("text-decoration","underline"),v.css("text-decoration","none"),g.css("text-decoration","none")),s>w.offset().top&&s<w.offset().top+w.height()&&(m.css("text-decoration","underline"),f.css("text-decoration","none"),v.css("text-decoration","none"),g.css("text-decoration","none")),($(window).scrollTop()+$(window).height()>$(document).height()-25||s>$("#contact").offset().top)&&(m.css("text-decoration","none"),f.css("text-decoration","none"),v.css("text-decoration","none"),g.css("text-decoration","underline"))});var k=$("html, body"),b=function(o){return k.animate({scrollTop:$("#"+o).offset().top-65},200),!1};$(document).on("click","#navName",function(o){o.preventDefault(),b("top")}),$(document).on("click","#downArrow",function(o){o.preventDefault(),b("about")}),$(document).on("click","#navAbout",function(o){o.preventDefault(),b("about")}),$(document).on("click","#navSkills",function(o){o.preventDefault(),b("skills")}),$(document).on("click","#navPortfolio",function(o){o.preventDefault(),b("portfolio")}),$(document).on("click","#navContact",function(o){o.preventDefault(),b("contact")})}
