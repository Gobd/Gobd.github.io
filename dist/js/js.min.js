...
var stateObj={};$(document).ready(function(){function t(t){t?e.css("visibility","visible"):e.css("visibility","hidden")}function n(){$(window).scrollTop(stateObj.scrollData-70)}function i(n){a.html(n),t(!0)}function o(){"#/projects"===window.location.hash?(stateObj.projectsHtml?i(stateObj.projectsHtml):$.get("/projects.html",function(t){}).then(function(t){stateObj.projectsHtml=t,i(t)}),$(window).off()):(window.location.hash="#",stateObj.indexHtml?(i(stateObj.indexHtml),mainPage(),n()):$.get("/mainTemp.html",function(t){}).then(function(t){stateObj.indexHtml=t,i(t),mainPage(),n()}))}var a=$("#main"),e=$("body");window.onhashchange=function(){t(!1),o()},window.location.hash&&"#/"!==window.location.hash||a.html()&&(stateObj.indexHtml=a.html()),o()});
function mainPage(){function t(t){var o=1,e=function(){n.text(t.slice(0,o)),o++,o===t.length+1&&(clearInterval(i),stateObj.printed=!0)},a=function(){return 30*Math.random()+70},i=window.setInterval(e,a())}function o(t){var o=t.getBoundingClientRect().top,e=t.getBoundingClientRect().bottom,n=o>=0&&e<=window.innerHeight;return n}function e(){768>s||c>75?(l.css("background-color","white"),f.css("color","black")):(l.css("background-color","transparent"),f.css("color","#ebeaea")),s>768&&(r.css("max-height","65px"),g.removeClass("active"))}var n=$("#devInfo"),a="Full Stack Web Developer | UI/UX | JavaScript";stateObj.printed?n.text(a):t(a);var i=document.getElementsByTagName("svg"),c=$(window).scrollTop()+70,s=$(window).width(),r=$("#innerNav"),l=$("#navigation"),f=l.find("a"),g=$("#navToggle");$(window).resize(function(){s=$(window).width(),e()});var d=$("#navSkills"),v=$("#navPortfolio"),h=$("#navContact"),u=$("#top"),p=$("#portfolio"),w=$("#skills"),m=$("#about"),b=$("#navAbout"),x=function(t,o){t.forEach(function(t,e){0!==e||o?t.css("text-decoration","none"):t.css("text-decoration","underline")})};$(window).scroll(function(){c=$(window).scrollTop()+70,stateObj.scrollData=c,e(),[].forEach.call(i,function(t){o(t)?$(t).addClass("svgGrow"):$(t).removeClass("svgGrow")}),$(window).scrollTop()+$(window).height()>$(document).height()-30||c>$("#contact").offset().top?x([h,b,d,v]):c<u.offset().top+u.height()?x([b,d,v,h],!0):c>p.offset().top&&c<p.offset().top+p.height()?x([v,b,d,h]):c>w.offset().top&&c<w.offset().top+w.height()?x([d,v,b,h]):c>m.offset().top&&c<m.offset().top+m.height()&&x([b,d,v,h])});var k=function(t){("top"!==t||g.hasClass("active"))&&(g.toggleClass("active"),"65px"===r.css("max-height")?r.css("max-height","500px"):r.css("max-height","65px"))};$(document).on("click","#navToggle",function(){k()}),$(document).on("click",".navLink",function(t){var o=t.target.id.slice(3,t.target.id.length).toLowerCase();t.preventDefault(),scrollGlobe(o),k(o)})}var scrollGlobe=function(t,o){var e=t;return root.animate({scrollTop:$("#"+e).offset().top-65},200),!1},root=$("html, body");
