...
var stateObj={};$(document).ready(function(){function t(t){t?a.css("visibility","visible"):a.css("visibility","hidden")}function n(){$(window).scrollTop(stateObj.scrollData-70)}function i(){"#/asd"===window.location.hash?stateObj.testHtml?(o.html(stateObj.testHtml),t(!0),$(window).off()):$.get("/test.html",function(t){}).then(function(n){stateObj.testHtml=n,o.html(n),t(!0),$(window).off()}):(window.location.hash="#",stateObj.indexHtml?(o.html(stateObj.indexHtml),mainPage(),t(!0),n()):$.get("/mainTemp.html",function(t){}).then(function(i){stateObj.indexHtml=i,o.html(i),mainPage(),t(!0),n()}))}var o=$("#main"),a=$("body");window.onhashchange=function(){t(!1),i()},window.location.hash&&"#/"!==window.location.hash||o.html()&&(stateObj.indexHtml=o.html()),i()});
function mainPage(){function o(o){var t=1,e=function(){c.text(o.slice(0,t)),t++,t===n.length+1&&clearInterval(i)},s=function(){return 30*Math.random()+70},i=window.setInterval(e,s())}function t(o){var t=o.getBoundingClientRect().top,e=o.getBoundingClientRect().bottom,n=t>=0&&e<=window.innerHeight;return n}function e(){768>a?(l.css("background-color","white"),d.css("color","black")):75>i?(l.css("background-color","transparent"),d.css("color","#ebeaea")):(l.css("background-color","white"),d.css("color","black"))}var n="Full Stack Web Developer | UI/UX | JavaScript",c=$("#devInfo");o(n);var s=document.getElementsByTagName("svg"),i=$(window).scrollTop()+70,a=$(window).width(),r=$("#innerNav"),l=$("#navigation"),d=l.find("a"),f=$("#navToggle");$(document).on("click","#navToggle",function(){f.toggleClass("active"),"65px"===r.css("max-height")?r.css("max-height","500px"):r.css("max-height","65px")}),$(window).resize(function(){a=$(window).width(),e()}),e();var g=$("#navSkills"),u=$("#navPortfolio"),h=$("#navContact"),v=$("#top"),x=$("#portfolio"),w=$("#skills"),p=$("#about"),m=$("#navAbout");$(window).scroll(function(){i=$(window).scrollTop()+70,stateObj.scrollData=i,e(),[].forEach.call(s,function(o){t(o)?$(o).addClass("svgGrow"):$(o).removeClass("svgGrow")}),i<v.offset().top+v.height()&&(m.css("text-decoration","none"),g.css("text-decoration","none"),u.css("text-decoration","none"),h.css("text-decoration","none")),i>x.offset().top&&i<x.offset().top+x.height()&&(m.css("text-decoration","none"),g.css("text-decoration","none"),u.css("text-decoration","underline"),h.css("text-decoration","none")),i>w.offset().top&&i<w.offset().top+w.height()&&(m.css("text-decoration","none"),g.css("text-decoration","underline"),u.css("text-decoration","none"),h.css("text-decoration","none")),i>p.offset().top&&i<p.offset().top+p.height()&&(m.css("text-decoration","underline"),g.css("text-decoration","none"),u.css("text-decoration","none"),h.css("text-decoration","none")),($(window).scrollTop()+$(window).height()>$(document).height()-25||i>$("#contact").offset().top)&&(m.css("text-decoration","none"),g.css("text-decoration","none"),u.css("text-decoration","none"),h.css("text-decoration","underline"))}),$(document).on("click",".navLink",function(o){o.preventDefault(),scrollGlobe(o.target.id),f.hasClass("active")&&f.removeClass("active"),r.css("max-height","65px")})}var scrollGlobe=function(o,t){var e;return e=t?o:o.slice(3,o.length).toLowerCase(),root.animate({scrollTop:$("#"+e).offset().top-65},200),!1},root=$("html, body");
